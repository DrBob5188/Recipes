...
%%Start recipe
\newrecipe{5 Minute Chocolate Cake}{}
...
%%Start recipe
\newrecipe{Devilishly Dark Chocolate Cake}{}
...
\begin{ingredients-list}
	...
	\item 1\sfrac{1}{2} cups hot water
	\item 2 cups caster sugar (Reduce to 1\sfrac{1}{2} cups if desired)
	\item 1\sfrac{1}{2} cups self raising flour
	\item \sfrac{1}{4} cup cocoa
	\item 2 eggs
...
\begin{enumerate}
	...
	\item Bake for 1\sfrac{1}{2} hours at 150 \textcelsius (Fan Forced) or 160 \textcelsius conventional oven.
